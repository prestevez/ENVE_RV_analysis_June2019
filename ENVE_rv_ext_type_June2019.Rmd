...
enve_lag_nm_sem1 %>%
    mutate(
        lag_extincs_adj = capadjust(lag_extincs, extincs, 7)*100,
        lag_rmt_adj = capadjust(lag_remote, extincs + lag_extincs - lag_remote, 7)*100,
        lag_inp_adj = capadjust(lag_inperson, extincs + lag_extincs - lag_inperson, 7)*100
    ) -> enve_lag_nm_sem1
